...
export default function LoginPage() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#060d1a] flex items-center justify-end overflow-hidden">
      ...
      {/* Right-side fade so card stays readable */}
      ...
      <div className="relative z-10 w-[370px] mr-[65vw] p-[38px_34px] rounded-2xl bg-[#060e1ea8] border border-white/[0.07] backdrop-blur-xl max-sm:mr-0 max-sm:mx-4">
        ...
        <h1 className="text-[22px] font-semibold text-[#e8f2ff] tracking-tight mb-1">Welcome back</h1>
        <p className="text-[13px] font-light text-blue-200/40 mb-7">Sign in to your account</p>
        ...
        <div className="flex items-center justify-between mt-1.5 mb-5">
          <label className="flex items-center gap-2 text-xs text-blue-200/40 cursor-pointer select-none">
            <input type="checkbox" className="accent-blue-500 cursor-pointer" />
            Keep me signed in
          </label>
          <a href="#" className="text-xs text-blue-400/55 hover:text-blue-400/85 transition-colors">
            Forgot password?
          </a>
        </div>
